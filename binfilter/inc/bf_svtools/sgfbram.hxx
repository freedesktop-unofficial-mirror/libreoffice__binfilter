...
#define SgfVectFarb 4 /* Farben f�r Linien verwenden        Ŀ              */
#define SgfVectGray 5 /* Graustufen f�r Linien verwenden     � Nur f�r      */
#define SgfVectWdth 6 /* Strichst�rken f�r Linien verwenden �� SimpVector   */
...
{
public:
    UINT32 Size;       // Gr��e des BmpInfoHeaders
    ...
    UINT32 ImgSize;    // Gr��e der Images in Bytes. Ohne Kompression ist auch 0 erlaubt.
