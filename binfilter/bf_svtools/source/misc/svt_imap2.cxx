 ...
 *
 *  $RCSfile: svt_imap2.cxx,v $
 *
 *  $Revision: 1.2 $
 *
 *  last change: $Author: rt $ $Date: 2008-03-12 08:58:58 $
 *
...
{
    rStr += ByteString( String(::binfilter::simpleNormalizedMakeRelative( rBaseURL, aURL )), gsl_getSystemTextEncoding() );
}
